...
export const BentoGrid = ({
	...
	return (
		<div
			className={cn(
				" grid-cols-5 md:grid-cols-3 gap-8 max-w-7xl  grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-8 mx-auto",
				className
			)}>
			{children}
		</div>
				...
				<div>
					...
					{id === 6 && (
						<BackgroundGradientAnimation>
							<div className="aboslute z-50 flex itemes-center justify-center text-white font-bold"></div>
						</BackgroundGradientAnimation>
					)}
				</div>
				<div
